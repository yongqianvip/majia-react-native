...
// let store = createStore(rootReducer.testReducer())

// store.dispatch(testAction('jjjjjjjggggggggg'))
    ...
    render() {
        ...
        return (
            <ScrollableTabView initialPage={0}
                renderTabBar={()=> <Tabbar goToPage={this.goToPage} activeTab={1} tabNames={this.state.tabNames} tabIconsName={this.state.tabIconsName} />} 
                tabBarPosition='bottom'

                >
                <View style={styles.all} tabLabel="key1">
                ...
                <View style={styles.all} tabLabel='key3'>
                    <View style={styles.header}>
                    </View>
                    <ListView
                        dataSource={this.state.dataSource}
                ...
                <View style={styles.all} tabLabel='key4'>
                    <View style={styles.header}>
                    </View>
                </View>
            </ScrollableTabView>
